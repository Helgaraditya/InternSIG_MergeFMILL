...
# Sheet FMILL#5 – FMILL#9
fmill_sheets = [f"FMILL#{i}" for i in range(5, 10)]

# Header 15 kolom
fmill_header_15 = [
    "Date", "Production (TPD)", "Production (TPH)", "Running Time",
    "Running Time (HRC)", "% Run HRC", "Number of Stops", "KWH MILL",
    "KWH SEPARATOR", "KWH Fan", "KWH MAIN", "KWH/TON",
...
for subfolder in os.listdir(base_folder):
    ...
    for file in os.listdir(subfolder_path):
        ...
        for sheet in fmill_sheets:
            ...
            try:
                # Kolom: G,H,I,K,L,M,N,O,P,Q,S,T,U,V,W = kolom index [6,7,8,10,11,12,13,14,15,16,18,19,20,21,22]
                df = pd.read_excel(
                    xl,
                    sheet_name=sheet,
                    skiprows=7,
...
if all_data_fmill:
    ...
    output_path = r"D:\MAGANG SIG\TUGAS 2 - MERGE FMILL\FMILL_5_9_FINAL.xlsx"
